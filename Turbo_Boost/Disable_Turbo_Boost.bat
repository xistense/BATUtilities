...
@powercfg -setacvalueindex %CurrentPowerPlanGUID% 54533251-82be-4824-96c1-47b60b740d00 be337238-0d82-4146-a960-4f3749d470c7 0 >nul 2>&1
@powercfg -setdcvalueindex %CurrentPowerPlanGUID% 54533251-82be-4824-96c1-47b60b740d00 be337238-0d82-4146-a960-4f3749d470c7 0 >nul 2>&1
...
IF "%KeyValueAC%"=="0x0" IF "%KeyValueDC%"=="0x0" (GOTO SUCCESS)

:FAIL
msg "%username%" Disabling Turbo Boost failed or unsupported! ! !
GOTO EXIT0

:SUCCESS
msg "%username%" Turbo Boost is now disabled!
